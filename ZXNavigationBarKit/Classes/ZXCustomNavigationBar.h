...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (offsetY <= 0) {
        ...
        [self.customNavigationBar setBarBackgroundContainerAlpha:0 animated:YES];
    }
    else
    {
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    {
        [self.customNavigationBar setBarBackgroundContainerAlpha:0 animated:animated];
    ...
    else
    {
        ...
        else
        {
            ...
            [self.customNavigationBar setBarBackgroundContainerAlpha:alpha animated:YES];
        }
    }
}
*/
